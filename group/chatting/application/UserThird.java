...
public class UserThird implements ActionListener, Runnable {
    ...
    UserThird() {
        ...
        p1.setBackground(new Color(8, 80, 135));
        ...
        morevert.setBounds(380, 20, 10, 25);
        p1.add(morevert);
        
        JLabel name = new JLabel("Friends");
        name.setBounds(110, 15, 100, 18);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("Forte", Font.BOLD, 18));
        p1.add(name);
        
        JLabel status = new JLabel("Jenny, Sofia, Michelle");
        ...
        send.setBounds(320, 655, 98, 40);
        send.setBackground(new Color(8, 80, 135));
    ...
    public static JPanel formatLabel(String out) {
        ...
        output.setBackground(new Color(148, 209, 255));
